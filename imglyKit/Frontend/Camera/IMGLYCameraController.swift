...
//        upperMaskDarkenLayer.anchorPoint = CGPoint(x: 0.5, y: 0.5)
        ...
        upperMaskDarkenLayer.position = CGPoint(x: previewView.layer.bounds.midX, y: previewView.layer.bounds.midY)
    }
...
//        lowerMaskDarkenLayer.anchorPoint = CGPoint(x: 0.5, y: 0.5)
        ...
        lowerMaskDarkenLayer.position = CGPoint(x: previewView.layer.bounds.midX, y: previewView.layer.bounds.midY)
    }
...
private func GetTransformForDeviceOrientation(_ orientation: AVCaptureVideoOrientation, mirrored: Bool = false) -> CGAffineTransform {
    ...
    case .portraitUpsideDown:
        result = CGAffineTransform(rotationAngle: CGFloat(3 * Double.pi/2))
    case .landscapeRight:
        result = mirrored ? CGAffineTransform(rotationAngle: CGFloat(Double.pi)) : CGAffineTransform.identity
    case .landscapeLeft:
        result = mirrored ? CGAffineTransform.identity : CGAffineTransform(rotationAngle: CGFloat(Double.pi))
    }
